<template>
    <header class='flex border-b py-4 px-4 sm:px-10 backdrop-blur-lg bg-[#d6deec] font-[sans-serif] min-h-[70px] tracking-wide relative z-50 shadow-lg'>
    <div class='flex flex-wrap items-center gap-5 w-full'>
    <router-link to="/">
        <img src="@/assets/logo.png" alt="" class="w-24  ">
    </router-link>
